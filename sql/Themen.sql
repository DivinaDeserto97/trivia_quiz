...
--
-- Host: mysql
-- Erstellungszeit: 27. Jan 2023 um 21:12
...
INSERT INTO `Themen` (`id`, `thema`, `autor`, `image_class_parameter`) VALUES
(1, 'Hammond Organs & other Music Questions', 'Chris', ''),
(2, 'Chuck Norris', 'Jules', ''),
(3, 'Animal', 'Daniel', ''),
(4, 'Movies', 'Cyrill', ''),
(5, 'D&D', 'Tobias', '');
